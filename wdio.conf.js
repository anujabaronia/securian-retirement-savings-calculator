...
import fs from 'fs';
const screenshotDir = path.resolve('./temp/screenshots');
export const config = {
    //
    // ====================
    ...
    beforeSession: async function (config, capabilities, specs, cid) {
        try {
            if (fs.existsSync(screenshotDir)) {
                ...
                console.log("Old screenshots deleted before new test execution.");
            } else {
                fs.mkdirSync(screenshotDir, { recursive: true });
            }
        } catch (error) {
            console.error("Error cleaning screenshot folder:", error);
        }
    },
    /**
    ...
    afterStep: async function (step, scenario, result, context) {
        try {
            ...
            context.attach(`Step Screenshot`, fs.readFileSync(screenshotPath), 'image/png');
        } catch (error) {
